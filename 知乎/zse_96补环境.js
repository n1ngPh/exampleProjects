...
Object.defineProperty(window, '_resourceLoader', {
    value: undefined
});
Object.defineProperty(window, '_sessionHistory', {
    value: undefined
});
...
function createProxy(obj, name) {
    return new Proxy(obj, {
        ...
        get(target, property, receiver) {
            if (property === 'CanvasRenderingContext2D') {
                debugger;
            }
...
// 创建代理并设置全局对象
// global.window = createProxy(global.window || {}, 'window');
// global.location = createProxy(global.location || {}, 'location');
// global.navigator = createProxy(global.navigator || {}, 'navigator');
// global.document = createProxy(global.document || {}, 'document');
// global.history = createProxy(global.history || {}, 'history');
// global.screen = createProxy(global.screen || {}, 'screen');

// 示例调用
// console.log(global.window.__proto__.constructor.toString());



!function(xx) {
    "use strict";
    var e, a, c, d, f, t, r, b, o, n, i, s, u, l = {}, m = {};
    function p(e) {
        var a = m[e];
        if (void 0 !== a)
            return a.exports;
    ...
    // window.zse_96 = D('7d231a16e30ee2a3512cdf7a30f05226')
    window.zse_96 = D;
    // exports.XL = A,
    // exports.ZP = D
},
...
function get_zse_96(input){
    let md5_str = crypto.createHash('md5').update(input).digest('hex');
    window.pp(1514);
    return window.zse_96(md5_str)
}

input = '101_3_3.0+/api/v4/search_v3?gk_version=gz-gaokao&t=general&q=%E8%8B%B9%E6%9E%9C&correction=1&offset=0&limit=20&filter_fields=&lc_idx=0&show_all_topics=0&search_source=Normal+AYBR8KXGyhiPTm9j4SqSdUMMaFafpM6xKn0=|1718704925'
console.log(get_zse_96(input))
