...
function getUserresponse(g7z,challenge){
    return i7B[M9r.R8z(722)](g7z,challenge);
}
s6z = function(F6z) {
...
function t(K1z,track) {
                                        ...
                                        while (X8r !== M9r.k9r()[34][15][45]) {
                                            ...
                                            case M9r.k9r()[4][32][24]:
                                                var N1z, X1z = s6z(track), f1z = [], B1z = [], o1z = [], t1z = 0, j1z = X1z[M9r.R8z(40)];
...
function getF7z(track,c,s){
    var F7z = t(1693302254088,track);
    return u(F7z,c,s)
}
...
function get_rp(gt,challenge,passtime){
    var params = gt + challenge.slice(0,32) + passtime
    return I0B(params);
}
var n0B = function() {
...
function get_q7z(Y7z,key){
    var Y7z = JSON.stringify(Y7z)
    return n0B.encrypt(Y7z,key)
}
var p7B = {
                        '\x75\x61': {
                            '\x76\x61': M9r.C8z(144),
