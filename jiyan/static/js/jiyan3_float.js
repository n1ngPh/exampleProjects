...
function t() {
    var random_str = (65536 * (1 + Math["random"]()) | 0)["toString"](16)["substring"](1);
    return random_str;
}
...
function get_h(params){
    var rp_ = params['gt'] + params['challenge_2'].slice(0, 32) + params["passtimes"];
    var aa = getAA($_FDL(params["track"]), params['c'], params['s']);
    var o = {
    "lang": "zh-cn",
    "userresponse": H(params["distance"], params['challenge_2']),
    "passtime": params["passtimes"],
    "imgload": 58,
    "aa": aa,
    "ep": {
        "v": "7.9.0",
    ...
    "h9s9": "1816378497",
    "rp": CryptoJS.MD5(rp_).toString()};
    var l = aesV(JSON.stringify(o), randomStr)
    // console.log(aa)
    var h = m(l);
    return h;
}

function get_w(params){
...
app.post('/get_w', (req, res) => {
  const params = req.body; // 获取请求体中的参数
    console.log("gogogo2", params)
  const w = get_w(params); // 调用 get_w 函数
    const responseObj = {
    msg: "success",
    w: w
  };
  res.send(responseObj); // 将结果发送回给请求方
});
...
// var p = {'gt': '019924a82c70bb123aae90d483087f94', 'challenge_2': '8d215b6b1f82f3290f7abe2280f203316k', 's': '58555666', 'c': [12, 58, 98, 36, 43, 95, 62, 15, 12], 'distance': 143, 'passtimes': 1085, 'track': [[-37, -30, 0], [0, 0, 0], [1, 0, 33], [2, 0, 41], [3, 1, 49], [7, 2, 57], [9, 3, 63], [14, 4, 70], [20, 5, 79], [25, 7, 86], [32, 8, 94], [39, 8, 102], [44, 8, 109], [49, 8, 118], [53, 8, 126], [57, 8, 135], [61, 8, 142], [65, 8, 150], [67, 8, 158], [69, 8, 167], [72, 8, 174], [75, 8, 182], [78, 8, 190], [79, 8, 199], [82, 8, 206], [85, 8, 214], [88, 8, 222], [91, 8, 231], [94, 8, 238], [97, 8, 247], [99, 8, 254], [101, 8, 261], [102, 8, 270], [104, 8, 278], [106, 8, 286], [108, 8, 294], [109, 8, 302], [110, 8, 310], [111, 8, 318], [113, 8, 334], [114, 8, 350], [115, 8, 386], [116, 8, 392], [117, 8, 401], [119, 8, 417], [121, 8, 424], [123, 9, 438], [124, 9, 447], [126, 9, 454], [127, 9, 463], [128, 9, 470], [129, 9, 478], [131, 9, 494], [133, 10, 502], [133, 11, 511], [134, 11, 525], [135, 11, 533], [136, 11, 550], [137, 11, 574], [138, 11, 583], [139, 11, 589], [139, 12, 606], [141, 12, 614], [142, 12, 621], [143, 12, 638], [143, 12, 1085]]}
// console.log(get_w(p))
